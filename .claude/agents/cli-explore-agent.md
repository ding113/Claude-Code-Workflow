...
→ Format output as structured markdown or TOON
...
**Output**: Dependency graph (TOON/DOT format) + risk assessment report
...
**Output**: Dependency Map Report (TOON + Markdown summary)
**Time**: 3-8 minutes
